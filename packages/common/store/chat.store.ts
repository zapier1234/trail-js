...
const loadInitialData = async () => {
    ...
    const config = configStr
        ...
        : {
              ...
              chatMode: ChatMode.CEREBRAS_LLAMA_3_1_8B,
          };
    const chatMode = config.chatMode || ChatMode.CEREBRAS_LLAMA_3_1_8B;
            ...
            try {
                ...
                try {
                    const fallbackItem = {
                        ...
                        mode: threadItem.mode || ChatMode.CEREBRAS_LLAMA_3_1_8B,
                        createdAt: new Date(),
                        updatedAt: new Date(),
                        ...threadItem,
